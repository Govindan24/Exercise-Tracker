...
const PROPAGATOR_LOOKUP_MAP = {
    ...
    tracecontext: core_1.W3CTraceContextPropagator,
    baggage: core_1.W3CBaggagePropagator,
};
...
function configureBaseResource(config) {
    const attributes = {
        ...
        [TELEMETRY_DISTRO_VERSION]: version_1.VERSION,
    };
    if (config.serviceVersion) {
        attributes[semantic_conventions_1.SemanticResourceAttributes.SERVICE_VERSION] =
            config.serviceVersion;
    }
    attributes[semantic_conventions_1.SemanticResourceAttributes.HOST_NAME] =
...
function configureInstrumentations(config) {
    ...
    config.instrumentations = [(0, auto_instrumentations_node_1.getNodeAutoInstrumentations)()];
}
/**
...
function configureTraceExporter(config) {
    ...
    config.traceExporter = new exporter_trace_otlp_proto_1.OTLPTraceExporter({
